...
const RefundAndReturnsPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 mt-16 text-black">
      ...
      <h3 className="text-lg font-bold mt-4">Returns & Refunds policy:</h3>
      <p>
      ...
      <h3 className="text-lg font-bold mt-4">Conditions for returns:</h3>
      <p>
      ...
      <h3 className="text-lg font-bold mt-4">Returning Goods:</h3>
      <p>
      ...
      <h3 className="text-lg font-bold mt-4">Gifts:</h3>
      <p>
